...
type ReadFortschrittClientProps = {
  bibleLang: BibleReadLang;
};

export function ReadFortschrittClient({ bibleLang }: ReadFortschrittClientProps) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      <ReadSubNav current="fortschritt" bibleLang={bibleLang} />
